...
<img src="https://i.imgur.com/jz7k0kr.png" height="80%" width="80%" alt="Create VM Newtwork Security Group"/>
<br />
</p>

<h3 align="center">Create & Configure Log Analytics workspace</h3>
<p align="center">
Namimg and creating the Log Analytics workspace instance. The Log Analytics workspace will be utilized to ingest the failed RDP logins log data from the honeypot VM.<br/>
